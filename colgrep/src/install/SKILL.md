...
| `--include` | Include files matching pattern | `colgrep --include="*.py" "query"` |
...
8. **Agents should use `colgrep`** - when spawning Task/Explore agents, they should also use colgrep instead of Grep
