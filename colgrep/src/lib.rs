...
pub use index::{
    bre_to_ere, escape_literal_braces, index_exists, path_contains_ignored_dir, EncodeSortOrder,
    IndexBuilder, SearchResult, Searcher, UpdatePlan, UpdateStats, CONFIRMATION_THRESHOLD,
};
